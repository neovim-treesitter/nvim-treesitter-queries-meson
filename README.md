# nvim-treesitter-queries-meson

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-meson/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-meson/actions/workflows/validate.yml)

Neovim tree-sitter queries for **meson**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-meson",
...
- [ ] Changes are scoped to `meson` — do not include files for other languages
